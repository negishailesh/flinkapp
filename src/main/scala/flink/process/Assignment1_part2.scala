...
object Assignment1_part2 {
  def main(args:Array[String]):Unit = {
    ...
    avgNoOfPassenger.writeAsText("/home/shaileshnegi/Documents/scala/flinkApp/src/main/scala/flink/data/assignment_result2")
  ...
  class Splitter extends MapFunction[String , Tuple3[String ,Integer, Integer]]{
    def map(value : String):Tuple3[String,Integer,Integer] = {
      ...
      new Tuple3[String,Integer,Integer](
        if (words(5) != "'null'") words(5) else "Unknown",
